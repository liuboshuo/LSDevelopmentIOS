...
-(void)viewDidLoad
{
    ...
    //    self.navigationItem.leftBarButtonItem = [self leftButtonItemWithTitle:@"导航0" isBackBarButtonItem:NO];
    self.navigationItem.rightBarButtonItem = [self rightButtonItemWithTitle:@"导航1"];
}
