...
+ (UIViewController *)activityViewController
{
    ...
    if ([curentController isKindOfClass:[UITabBarController class]]) {
        UITabBarController *current = (UITabBarController *)curentController;
        UINavigationController *nav =current.selectedViewController;
        return nav.visibleViewController;
    }else if ([curentController isKindOfClass:[UINavigationController class]]){
